...
// �berschrift einf�gen: ("" = keine �berschrift)
$LphpTitelText = "";

// Datumsangabe allein oder hinter �berschrift:
$LphpTitelDatum = 2;

// m�gliche Werte: (Beispiel 04.02.2008)
// 0 = (keine Datumsangabe)
// 1 = "04.02.2008"
// 2 = "Montag, 4. Februar 2008"
// 3 = "4. Februar 2008"

// Doppelpunkt hinter �berschrift / Datum (1 = Doppelpunkt    0 = keiner)
$LphpTitelDoppelpunkt = 0;


// =================================================================
// Den nachfolgenden Code bitte nur �ndern, wenn Sie sich auskennen!
// =================================================================
...
$LphpM = array("", "Januar", "Februar", "M�rz", "April", "Mai", "Juni", "Juli", "August", "September", "Oktober", "November", "Dezember");
